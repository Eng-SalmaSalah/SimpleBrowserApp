...
class WebsitesTableViewController: UITableViewController {
    ...
    var webSites = ["hackingwithswift.com","apple.com","google.com","facebook.com","twitter.com"]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if let websiteVC = storyboard?.instantiateViewController(withIdentifier: "websiteVC") as? ViewController{
            websiteVC.webSiteToLoad = webSites[indexPath.row]
